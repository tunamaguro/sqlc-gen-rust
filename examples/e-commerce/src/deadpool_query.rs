...
WHERE
    ...
    pub async fn query_opt(
        ...
        Option<GetProductWithCategoryRow>,
        deadpool_postgres::tokio_postgres::Error,
    > {
        let row = client.query_opt(Self::QUERY, &self.as_slice()).await?;
        match row {
...
WHERE attributes @> $1::jsonb";
    pub async fn query_many(
        ...
        Vec<GetProductsWithSpecificAttributeRow>,
        deadpool_postgres::tokio_postgres::Error,
    > {
...
WHERE oi.order_id = $1";
    pub async fn query_many(
        ...
        Vec<ListOrderItemsByOrderIdRow>,
        deadpool_postgres::tokio_postgres::Error,
    > {
...
GROUP BY product_id";
    ...
    pub async fn query_opt(
        ...
        Option<GetProductAverageRatingRow>,
        deadpool_postgres::tokio_postgres::Error,
    > {
        let row = client.query_opt(Self::QUERY, &self.as_slice()).await?;
        match row {
...
ORDER BY total_sales DESC";
    pub async fn query_many(
        ...
        Vec<GetCategorySalesRankingRow>,
        deadpool_postgres::tokio_postgres::Error,
    > {
